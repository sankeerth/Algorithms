...
class Solution:
    def verticalTraversal(self, root: Optional[TreeNode]) -> List[List[int]]:
        ...
        for col in range(mincol, maxcol+1):
            nodes[col].sort()
            res.append([val for _, val in nodes[col]])

        return res


sol = Solution()
print(sol.pruneTree(verticalTraversal('[3,9,20,null,null,15,7]')))
print(sol.pruneTree(verticalTraversal('[1,2,3,4,5,6,7]')))
print(sol.pruneTree(verticalTraversal('[3,1,4,0,2,2]')))
