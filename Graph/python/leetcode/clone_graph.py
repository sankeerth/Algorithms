        ...
        while queue:
            ...
            if old.neighbors:
                ...
                for oldnei in old.neighbors:
                    if oldnei in nodemap:
                        newnei = nodemap[oldnei]
                    else:
                        newnei = Node(oldnei.val)
                        nodemap[oldnei] = newnei
                    
                    new.neighbors.append(newnei)
                    if oldnei not in visited:
                        visited.add(oldnei)
                        queue.append((oldnei, newnei))
...
print(sol.cloneGraph(graph.adj_list[1]))
