...
sol = Solution()
print(sol.boundaryOfBinaryTree(deserialize("[1,null,2,3,4]")))
print(sol.boundaryOfBinaryTree(deserialize("[1,2,3,4,5,6,null,null,null,7,8,9,10]")))
print(sol.boundaryOfBinaryTree(deserialize("[1]")))
print(sol.boundaryOfBinaryTree(deserialize("[null]")))
